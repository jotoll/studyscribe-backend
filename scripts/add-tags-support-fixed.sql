-- Script para agregar soporte de etiquetas al sistema Dicttr (versión corregida)
-- Ejecutar este script en la base de datos de Supabase

-- 1. Crear tabla de etiquetas (con referencia corregida a users en lugar de auth.users)
