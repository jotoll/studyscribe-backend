...
function MainScreen() {
  ...
  const processRecording = async (audioUri: string) => {
    setLoading(true);
    try {
      // Enviar audio al backend para transcripción real
      ...
      if (response.success && response.data.transcription) {
        ...
        setEnhancedText(response.data.transcription.enhanced || null);
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerRight}>
            ...
            >
              <Ionicons name="list" size={24} color="#4A00E0" />
            </TouchableOpacity>
            <Text style={styles.meetingInfo}>StudyScribe + IA</Text>
          ...
          {enhancedText && Object.keys(enhancedText).length > 0 ? (
            <View style={styles.compactSection}>
              <View style={styles.windowHeader}>
                ...
                >
                  <Ionicons name="musical-notes" size={18} color="#4A00E0" />
                </TouchableOpacity>
                ...
                <View style={styles.windowActions}>
                  <TouchableOpacity 
                    ...
                    disabled={loading}
                  >
                    <Ionicons name="eye" size={18} color="#4A00E0" />
                  </TouchableOpacity>
                  <TouchableOpacity 
                  ...
                  >
                    <JSONRenderer 
                      ...
                      onEdit={(path, element) => {
                        ...
                        // Para todos los casos, abrir editor modal
                        console.log('Abriendo modal editor con:', path, element);
                        openModalEditor(enhancedText, path, element);
                      }}
